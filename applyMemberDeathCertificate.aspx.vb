...
Partial Class applyMemberDeathCertificate
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.OleDbSelectCommand1.CommandText = "select * from deathcertificate"
    ...
    Protected Sub DropDownList2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList2.SelectedIndexChanged
        ...
        Do While r.Read
            ...
            Me.TextBox10.Text = r.GetString(12)
        Loop
        Me.OleDbConnection1.Close()
    End Sub
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.OleDbConnection1.Open()
        Me.OleDbUpdateCommand1.CommandText = "update deathcertificate set numberofcopies='" & Me.TextBox11.Text & "' where deathcertificateid = " & Me.DropDownList2.Text & ""
