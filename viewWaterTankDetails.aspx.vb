...
Partial Class viewWaterTankDetails
...
#End Region
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList1.SelectedIndexChanged
        ...
        Me.OleDbSelectCommand1.CommandText = "select * from watertank where city ='" & Me.DropDownList1.Text & "'"
        r = Me.OleDbDataAdapter1.SelectCommand.ExecuteReader()
        Me.DropDownList2.Items.Clear()
        Do While r.Read
            Me.DropDownList2.Items.Add(r.GetString(1))
        Loop
    ...
    Protected Sub DropDownList2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList2.SelectedIndexChanged
        ...
        ds.Clear()
        Me.OleDbConnection1.Open()
        Me.OleDbSelectCommand1.CommandText = "select * from watertank where city ='" & Me.DropDownList1.Text & "' and area = '" & Me.DropDownList2.Text & "'"
