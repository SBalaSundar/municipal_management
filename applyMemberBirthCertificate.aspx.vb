...
Partial Class applyMemberBirthCertificate
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.OleDbSelectCommand1.CommandText = "select * from birthcertificate"
    ...
    Protected Sub DropDownList2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList2.SelectedIndexChanged
        Dim r As OleDbDataReader
        Me.OleDbConnection1.Open()
        Me.OleDbSelectCommand1.CommandText = "select * from birthcertificate where birthcertificateid=" & Me.DropDownList2.Text & ""
        r = Me.OleDbDataAdapter1.SelectCommand.ExecuteReader
        Do While r.Read
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.OleDbConnection1.Open()
        Me.OleDbUpdateCommand1.CommandText = "update birthcertificate set childname='" & Me.TextBox10.Text & "', numberofcopies='" & Me.TextBox11.Text & "' where birthcertificateid = " & Me.DropDownList2.Text & ""
        Me.OleDbDataAdapter1.UpdateCommand.ExecuteNonQuery()
        Me.OleDbConnection1.Close()
        Response.Redirect("members.aspx?Msg=Applied Successfully")
