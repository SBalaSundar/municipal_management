<%@ Page Language="VB" AutoEventWireup="false" CodeFile="hospitalLogin.aspx.vb" Inherits="hospitalLogin" %>
...
<body background="pattern.jpeg">
    ...
    <div>
        ...
        <asp:Label ID="Label2" runat="server" Style="z-index: 102; left: 32px; position: absolute;
            top: 256px" Text="Password"></asp:Label>
        <asp:Button ID="Button1" runat="server" Height="24px" Style="z-index: 103; left: 144px;
            position: absolute; top: 296px" Text="Login" Width="72px" />
        <asp:Label ID="Label3" runat="server" Font-Size="X-Large" Style="z-index: 104; left: 32px;
            position: absolute; top: 144px" Text="HOSPITAL LOGIN"></asp:Label>
        &nbsp;&nbsp;
        <asp:TextBox ID="TextBox2" runat="server" Style="z-index: 105; left: 144px; position: absolute;
            top: 256px" TextMode="Password" Width="152px"></asp:TextBox>
        <asp:LinkButton ID="LinkButton1" runat="server" Style="z-index: 106; left: 232px;
            position: absolute; top: 304px">Exit</asp:LinkButton>
        <asp:Label ID="Label4" runat="server" Style="z-index: 107; left: 32px; position: absolute;
            top: 192px"></asp:Label>
        <asp:Image ID="Image2" runat="server" Height="120px" ImageUrl="banner.jpg" Style="z-index: 109;
