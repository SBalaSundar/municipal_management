...
Partial Class adminviewMembersBirthCertificate
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.OleDbSelectCommand1.CommandText = "select * from birthcertificate where childname<>'-' and status='APPLIED'"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Me.OleDbConnection1.Open()
        Me.OleDbUpdateCommand1.CommandText = "update birthcertificate set status='APPROVED' where birthcertificateid = " & Me.DropDownList2.Text & ""
