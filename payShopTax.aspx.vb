...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Me.OleDbSelectCommand1.CommandText = "select * from shoptax where status='APPLIED'"
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList1.SelectedIndexChanged
        Dim r As OleDbDataReader
        Me.OleDbConnection1.Open()
        Me.OleDbSelectCommand1.CommandText = "select * from shoptax where shoptaxid=" & Me.DropDownList1.Text & ""
        r = Me.OleDbDataAdapter1.SelectCommand.ExecuteReader
        Do While r.Read
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Me.DropDownList3.Text = "ICICI" And Me.TextBox10.Text = "1111" And Me.TextBox11.Text = "1111" Then
            Me.OleDbConnection1.Open()
            Me.OleDbUpdateCommand1.CommandText = "update shoptax set status='PAID', BANKNAME ='" & Me.DropDownList3.Text & "',ACCOUNTNUMBER='" & Me.TextBox10.Text & "' where shopTAXid = " & Me.DropDownList1.Text & ""
            Me.OleDbDataAdapter1.UpdateCommand.ExecuteNonQuery()
            Me.OleDbConnection1.Close()
            Response.Redirect("members.aspx?Msg=Shop tax Paid Successfully")
