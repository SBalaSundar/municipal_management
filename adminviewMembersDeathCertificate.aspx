<%@ Page Language="VB" AutoEventWireup="false" CodeFile="adminviewMembersDeathCertificate.aspx.vb" Inherits="adminviewMembersDeathCertificate" %>
...
<body background="pattern.jpeg">
    ...
    <div>
        ...
        <asp:Label ID="Label2" runat="server" Style="z-index: 102; left: 16px; position: absolute;
            top: 256px" Text="Hospital Name"></asp:Label>
        <asp:Button ID="Button1" runat="server" Height="24px" Style="z-index: 103; left: 456px;
            position: absolute; top: 424px" Text="Approve" Width="72px" /><asp:Button ID="Button2" runat="server" Height="24px" Style="z-index: 104; left: 536px;
            position: absolute; top: 424px" Text="Exit" Width="72px" />
        <asp:Label ID="Label3" runat="server" Font-Size="X-Large" Style="z-index: 105; left: 16px;
            position: absolute; top: 136px" Text="APPROVE DEATH CERTIFICATE" Width="360px"></asp:Label>
        &nbsp;&nbsp;
        ...
        <asp:TextBox ID="TextBox11" runat="server" Style="z-index: 108; left: 152px; position: absolute;
        ...
        <asp:Label ID="Label5" runat="server" Style="z-index: 110; left: 16px; position: absolute;
            top: 352px" Text="Father Name"></asp:Label>
        ...
        <asp:Label ID="Label10" runat="server" Style="z-index: 118; left: 320px; position: absolute;
            top: 240px" Text="Death time"></asp:Label>
        <asp:TextBox ID="TextBox6" runat="server" Style="z-index: 119; left: 456px; position: absolute;
            top: 208px"></asp:TextBox>
        <asp:Label ID="Label11" runat="server" Style="z-index: 120; left: 320px; position: absolute;
            top: 272px" Text="Death date" Width="80px"></asp:Label>
        ...
        <asp:TextBox ID="TextBox8" runat="server" Height="16px" Style="z-index: 123; left: 456px;
            position: absolute; top: 272px" Width="152px"></asp:TextBox>
        <asp:Label ID="Label13" runat="server" Style="z-index: 124; left: 16px; position: absolute;
            top: 320px" Text="Person Name" Width="120px"></asp:Label>
        ...
        <asp:Label ID="Label14" runat="server" Style="z-index: 126; left: 320px; position: absolute;
            top: 392px" Text="Number Of Copies" Width="128px"></asp:Label>
