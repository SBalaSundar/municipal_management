...
#End Region
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Me.OleDbSelectCommand1.CommandText = "select * from hospital where hospitalid='" & Me.TextBox1.Text & "' and password='" & Me.TextBox2.Text & "'"
        ...
        If available = True Then
            Session("hospitalid") = TextBox1.Text
