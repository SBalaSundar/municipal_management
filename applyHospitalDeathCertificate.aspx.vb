...
Partial Class applyHospitalDeathCertificate
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Try
                Me.OleDbSelectCommand1.CommandText = "select max(deathcertificateid) from deathcertificate"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Me.OleDbConnection1.Open()
        Me.OleDbInsertCommand1.CommandText = "insert into deathcertificate values('" & Me.TextBox1.Text & "','" & Me.TextBox2.Text & "','" & Me.DropDownList1.Text & "','" & Me.TextBox3.Text & "','" & Me.TextBox4.Text & "','& gen &','" & Me.TextBox5.Text & "','" & Me.TextBox6.Text & "','" & Me.TextBox7.Text & "','" & Me.TextBox8.Text & "','0','APPLIED','" & Me.TextBox9.Text & "')"
        Me.OleDbDataAdapter1.InsertCommand.ExecuteNonQuery()
        Me.OleDbConnection1.Close()
        Me.Label4.Text = "death certificate Saved Successfully"
